...
<div class="bg-blue-50 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-xl bg-white rounded-lg shadow-lg p-8 ">
        <h2 class="text-2xl font-bold text-center text-slate-800 mb-6">Edit a Post</h2>
        ...
        <form wire:submit.prevent="update">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="title" wire:model="title" class="w-full px-4 py-2 border shadow-md border-blue-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mb-4 ">
                @if ($image)
                <div>
                    <img src="{{ $image->temporaryUrl() }}" alt="Image Preview" class="w-28  rounded-lg shadow">
                </div>
                @endif
            ...
            <div class="mb-4 border border-blue-400 shadow-md p-4 rounded-md">
                <label for="category" class="block text-slate-800  mb-2">Choose Category:</label>
            ...
            <div class="mb-4">
                ...
                <input type="hidden" id="x1" value={{$body}}>
                <trix-editor input="x1" class="bg-white  rounded-md px-4 border-blue-400 shadow-md"></trix-editor>
            ...
            <div class="flex gap-4 justify-end text-sm ">
                <!-- <a wire:navigate href="/posts" class=" px-4 py-2 rounded-lg hover:bg-gray-500 hover:text-white focus:outline-none">
                    Cancel
                </a> -->
